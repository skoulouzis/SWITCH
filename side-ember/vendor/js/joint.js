...
(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        define(['backbone', 'lodash.min', 'jquery'], function(Backbone, _, $) {
...
joint.shapes.switch = {};
  ...
  joint.shapes.switch.Attribute = joint.shapes.basic.Generic.extend({

    markup: '<g class="rotatable"><g class="scalable"><circle class="body"/></g><path class="icon"/><text class="label"/></g>',
    ...
    defaults: joint.util.deepSupplement({
      ...
      attrs: {
        ...
        '.label': { text: 'Attribute', 'ref-x': .5, 'ref-y': 35, ref: '.body', 'text-anchor': 'middle', fill: '#000000' },
        '.icon': { transform: 'scale(0.0075) scale(1,-1)', 'ref-x': .5, 'ref-y': 20, 'x-alignment': 'middle', 'y-alignment': 'bottom', ref: '.body', d: 'M704 280v-240q0 -16 -12 -28t-28 -12h-240q-16 0 -28 12t-12 28v240q0 16 12 28t28 12h240q16 0 28 -12t12 -28zM1020 880q0 -54 -15.5 -101t-35 -76.5t-55 -59.5t-57.5 -43.5t-61 -35.5q-41 -23 -68.5 -65t-27.5 -67q0 -17 -12 -32.5t-28 -15.5h-240q-15 0 -25.5 18.5 t-10.5 37.5v45q0 83 65 156.5t143 108.5q59 27 84 56t25 76q0 42 -46.5 74t-107.5 32q-65 0 -108 -29q-35 -25 -107 -115q-13 -16 -31 -16q-12 0 -25 8l-164 125q-13 10 -15.5 25t5.5 28q160 266 464 266q80 0 161 -31t146 -83t106 -127.5t41 -158.5z', fill: '#000000' }
      }
  ...
  joint.shapes.switch.VirtualResource = joint.shapes.basic.Generic.extend({

    markup: '<g class="rotatable"><g class="scalable"><rect class="body"/></g><path class="icon"/><text class="label"/></g>',
    ...
    defaults: joint.util.deepSupplement({
      ...
      attrs: {
        ...
        '.label': { text: 'Attribute', 'ref-x': .5, 'ref-y': 40, ref: '.body', 'text-anchor': 'middle', fill: '#000000' },
        '.icon': { transform: 'scale(0.0075) scale(1,-1)', 'ref-x': .5, 'ref-y': 22, 'x-alignment': 'middle', 'y-alignment': 'bottom', ref: '.body', d: 'M704 280v-240q0 -16 -12 -28t-28 -12h-240q-16 0 -28 12t-12 28v240q0 16 12 28t28 12h240q16 0 28 -12t12 -28zM1020 880q0 -54 -15.5 -101t-35 -76.5t-55 -59.5t-57.5 -43.5t-61 -35.5q-41 -23 -68.5 -65t-27.5 -67q0 -17 -12 -32.5t-28 -15.5h-240q-15 0 -25.5 18.5 t-10.5 37.5v45q0 83 65 156.5t143 108.5q59 27 84 56t25 76q0 42 -46.5 74t-107.5 32q-65 0 -108 -29q-35 -25 -107 -115q-13 -16 -31 -16q-12 0 -25 8l-164 125q-13 10 -15.5 25t5.5 28q160 266 464 266q80 0 161 -31t146 -83t106 -127.5t41 -158.5z', fill: '#000000' }
      }
  ...
  joint.shapes.switch.Group = joint.shapes.basic.Generic.extend({
    ...
    defaults: joint.util.deepSupplement({
      ...
      attrs: {
        ...
        '.label': { text: 'Group', 'ref-x': 20, 'ref-y': -19, ref: '.body', 'x-alignment': 'left', 'y-alignment': 'top', 'text-anchor': 'left', fill: '#000000' },
        '.icon': { transform: 'scale(0.0075) scale(1,-1)', 'ref-x': 2, 'ref-y': -7, 'x-alignment': 'left', 'y-alignment': 'top', ref: '.body', d: 'M704 280v-240q0 -16 -12 -28t-28 -12h-240q-16 0 -28 12t-12 28v240q0 16 12 28t28 12h240q16 0 28 -12t12 -28zM1020 880q0 -54 -15.5 -101t-35 -76.5t-55 -59.5t-57.5 -43.5t-61 -35.5q-41 -23 -68.5 -65t-27.5 -67q0 -17 -12 -32.5t-28 -15.5h-240q-15 0 -25.5 18.5 t-10.5 37.5v45q0 83 65 156.5t143 108.5q59 27 84 56t25 76q0 42 -46.5 74t-107.5 32q-65 0 -108 -29q-35 -25 -107 -115q-13 -16 -31 -16q-12 0 -25 8l-164 125q-13 10 -15.5 25t5.5 28q160 266 464 266q80 0 161 -31t146 -83t106 -127.5t41 -158.5z', fill: '#000000' }
      }
  ...
  joint.shapes.switch.Host = joint.shapes.basic.Generic.extend({
    ...
    defaults: joint.util.deepSupplement({
      ...
      attrs: {
        ...
        '.label': { text: 'Host', 'ref-x': 20, 'ref-y': -19, ref: '.body', 'x-alignment': 'left', 'y-alignment': 'top', 'text-anchor': 'left', fill: '#000000' },
        '.icon': { transform: 'scale(0.0075) scale(1,-1)', 'ref-x': 2, 'ref-y': -7, 'x-alignment': 'left', 'y-alignment': 'top', ref: '.body', d: 'M704 280v-240q0 -16 -12 -28t-28 -12h-240q-16 0 -28 12t-12 28v240q0 16 12 28t28 12h240q16 0 28 -12t12 -28zM1020 880q0 -54 -15.5 -101t-35 -76.5t-55 -59.5t-57.5 -43.5t-61 -35.5q-41 -23 -68.5 -65t-27.5 -67q0 -17 -12 -32.5t-28 -15.5h-240q-15 0 -25.5 18.5 t-10.5 37.5v45q0 83 65 156.5t143 108.5q59 27 84 56t25 76q0 42 -46.5 74t-107.5 32q-65 0 -108 -29q-35 -25 -107 -115q-13 -16 -31 -16q-12 0 -25 8l-164 125q-13 10 -15.5 25t5.5 28q160 266 464 266q80 0 161 -31t146 -83t106 -127.5t41 -158.5z', fill: '#000000' }
      }
  ...
  joint.shapes.switch.Component = joint.shapes.basic.Generic.extend(_.extend({}, joint.shapes.basic.PortsModelInterface, {

    markup: '<g class="rotatable"><g class="scalable"><rect class="multi2"/><rect class="multi"/><rect class="body"/></g><text class="label"/><path class="icon"/><g class="inPorts"/><g class="outPorts"/></g>',
    portMarkup: '<g class="port port<%= id %>"><circle class="port-body"/><text class="port-label"/></g>',
    ...
    defaults: joint.util.deepSupplement({
      ...
      attrs: {
        ...
        '.multi': {
          width: 150, height: 250,
          stroke: '#000000',
          'ref-x': 3, 'ref-y': 3, ref: '.body'
        },
        '.multi2': {
          width: 150, height: 250,
          stroke: '#000000',
          'ref-x': 6, 'ref-y': 6, ref: '.body'
        },
        '.port-body': {
          r: 10,
          magnet: true,
        ...
        '.label': { text: 'Component', 'ref-x': .5, 'ref-y': -20, ref: '.body', 'text-anchor': 'middle', fill: '#000000' },
        '.icon': { transform: 'scale(0.0075) scale(1,-1)', 'ref-x': .5, 'ref-y': 20, 'x-alignment': 'middle', 'y-alignment': 'bottom', ref: '.body', d: 'M704 280v-240q0 -16 -12 -28t-28 -12h-240q-16 0 -28 12t-12 28v240q0 16 12 28t28 12h240q16 0 28 -12t12 -28zM1020 880q0 -54 -15.5 -101t-35 -76.5t-55 -59.5t-57.5 -43.5t-61 -35.5q-41 -23 -68.5 -65t-27.5 -67q0 -17 -12 -32.5t-28 -15.5h-240q-15 0 -25.5 18.5 t-10.5 37.5v45q0 83 65 156.5t143 108.5q59 27 84 56t25 76q0 42 -46.5 74t-107.5 32q-65 0 -108 -29q-35 -25 -107 -115q-13 -16 -31 -16q-12 0 -25 8l-164 125q-13 10 -15.5 25t5.5 28q160 266 464 266q80 0 161 -31t146 -83t106 -127.5t41 -158.5z', fill: '#000000' },
        '.inPorts .port-label': { x:-15, dy: 4, 'text-anchor': 'end', fill: '#000000'},
        '.outPorts .port-label':{ x: 15, dy: 4, fill: '#000000' },
    ...
    getPortAttrs: function(port, index, total, selector, type) {
      ...
      if (_.isObject(port)) {
        ...
        portId = port.id || _.uniqueId(type);
        // Make sure the generated ID stays the same for particular port.
        port.id = portId;
      ...
      attrs[portLabelSelector] = { text: portLabel, opacity: 0 };
      attrs[portBodySelector] = { port: { id: portId , type: type, label: portLabel } };
      attrs[portSelector] = { ref: '.body', 'ref-y': (index + 0.5) * (1 / total) };
  ...
  joint.shapes.switch.ComponentLink = joint.dia.Link.extend({
    defaults: joint.util.deepSupplement({
      type: 'switch.ComponentLink',
      attrs: {
        '.connection': { stroke: '#fe854f', 'stroke-width' : 2},
  ...
  joint.shapes.switch.ServiceLink = joint.dia.Link.extend({
    defaults: joint.util.deepSupplement({
  ...
  joint.shapes.switch.ComponentView = joint.dia.ElementView.extend(joint.shapes.basic.PortsViewInterface);
